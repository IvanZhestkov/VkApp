...
public class MyPreferencesManager {
    ...
    private static final String PREF_PUSH_NOTIFICATION_ADMIN = "pref_push_notification_admin";
    private static final String PREF_PUSH_NOTIFICATION_MEMBERS = "pref_push_notification_members";
    private static final String PREF_PUSH_NOTIFICATION_COMMENT_REPLIES = "pref_push_notification_comment_replies";
